...
hidden if the `libcurves-demo_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `libcurves-demo_DEVELOPER_MODE` to the configure
...
Runs the executable target `libcurves-demo_exe`.
